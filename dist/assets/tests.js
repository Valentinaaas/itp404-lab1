...
define('lab01/tests/lint/app.lint-test', [], function () {
  'use strict';
...
define('lab01/tests/lint/templates.template.lint-test', [], function () {
  'use strict';

  QUnit.module('TemplateLint');

  QUnit.test('lab01/templates/application.hbs', function (assert) {
    assert.expect(1);
    assert.ok(false, 'lab01/templates/application.hbs should pass TemplateLint.\n\nlab01/templates/application.hbs\n  2:0  error  Incorrect indentation for `<h1>` beginning at L2:C0. Expected `<h1>` to be at an indentation of 2 but was found at 0.  block-indentation\n  3:0  error  Incorrect indentation for `<h4>` beginning at L3:C0. Expected `<h4>` to be at an indentation of 2 but was found at 0.  block-indentation\n  7:0  error  Incorrect indentation for `{{#link-to}}` beginning at L7:C0. Expected `{{#link-to}}` to be at an indentation of 2 but was found at 0.  block-indentation\n  8:0  error  Incorrect indentation for `Lab\n` beginning at L8:C0. Expected `Lab\n` to be at an indentation of 2 but was found at 0.  block-indentation\n  15:0  error  Incorrect indentation for `<p>` beginning at L15:C0. Expected `<p>` to be at an indentation of 2 but was found at 0.  block-indentation\n');
  });

  QUnit.test('lab01/templates/index.hbs', function (assert) {
    assert.expect(1);
    assert.ok(false, 'lab01/templates/index.hbs should pass TemplateLint.\n\nlab01/templates/index.hbs\n  3:0  error  Incorrect indentation for `<div>` beginning at L3:C0. Expected `<div>` to be at an indentation of 2 but was found at 0.  block-indentation\n  4:0  error  Incorrect indentation for `<h3>` beginning at L4:C0. Expected `<h3>` to be at an indentation of 2 but was found at 0.  block-indentation\n  5:0  error  Incorrect indentation for `<p>` beginning at L5:C0. Expected `<p>` to be at an indentation of 2 but was found at 0.  block-indentation\n  6:0  error  Incorrect indentation for `<p>` beginning at L6:C0. Expected `<p>` to be at an indentation of 2 but was found at 0.  block-indentation\n  7:0  error  Incorrect indentation for `<p>` beginning at L7:C0. Expected `<p>` to be at an indentation of 2 but was found at 0.  block-indentation\n  8:0  error  Incorrect indentation for `<p>` beginning at L8:C0. Expected `<p>` to be at an indentation of 2 but was found at 0.  block-indentation\n');
  });

  QUnit.test('lab01/templates/loading.hbs', function (assert) {
    assert.expect(1);
    assert.ok(true, 'lab01/templates/loading.hbs should pass TemplateLint.\n\n');
  });
});
define('lab01/tests/lint/tests.lint-test', [], function () {
  'use strict';
...
define('lab01/tests/test-helper', ['lab01/app', 'lab01/config/environment', '@ember/test-helpers', 'ember-qunit'], function (_app, _environment, _testHelpers, _emberQunit) {
  'use strict';
...
define('lab01/tests/unit/routes/index-test', ['qunit', 'ember-qunit'], function (_qunit, _emberQunit) {
  'use strict';
...
require('lab01/tests/test-helper');
